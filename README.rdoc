...
* {R2CORBA}[https://www.remedy.nl/products/r2corba.html] generating Ruby code which is 100% open source
* {TAOX11}[https://taox11.remedy.nl] generating C++11 code
* {AXCIOMA}[https://www.axcioma.com] generating C++11 code
