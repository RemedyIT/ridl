...
{RIDL}[https://www.remedy.nl/products/ridl.html] is a Ruby library implementing an OMG \IDL parser/compiler frontend with support for pluggable (and stackable) backends.
...
Remedy IT has developed multiple backends for RIDL. These include one for {R2CORBA}[https://www.remedy.nl/products/r2corba.html] (generating Ruby code) which is 100% open source,  {TAOX11}[https://taox11.remedy.nl] (generating C++11 code), and {AXCIOMA}[https://www.axcioma.com] (generating C++11 code). When you want to know more about how Remedy IT can assist you with developing your own backend for RIDL contact sales@remedy.nl.
